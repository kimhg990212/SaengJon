// Role: 사업자 폐업 위험 진단 페이지 - 상호명 직접 입력 + 사업자번호 → 국세청 실시간 조회
        ...
        {!hasResult && (
          <div className="flex flex-col items-center text-center pt-16">
            ...
            <div className="w-full max-w-md text-left">
              ...
              {/* 상호명 */}
              <div className="mb-4">
                <label className="block text-[12px] text-gray-500 mb-1.5 font-mono tracking-wide">상호명</label>
                <input
                  type="text"
                  value={storeName}
            ...
            <div className="mt-16 grid grid-cols-2 gap-4 w-full max-w-2xl text-left">
              {[
                { num: '01', title: '상호명 입력', desc: '진단할 업체의 상호명을 직접 입력해주세요' },
                { num: '02', title: '번호 입력 후 즉시 조회', desc: '10자리 사업자등록번호를 입력하면 국세청에서 실시간 확인합니다' },
              ].map(s => (
          ...
          <div className="pt-4">
            <div className="flex items-start justify-between mb-8">
              <div>
                ...
                <h2 className="font-['Syne'] text-[32px] font-extrabold tracking-tight">{storeName}</h2>
                <div className="text-[13px] text-gray-500 mt-1">{ntsResult.b_no}</div>
              </div>
              <button
                onClick={handleReset}
              ...
              <div className="bg-gray-50 dark:bg-[#10141c] border border-black/[0.06] dark:border-white/[0.07] rounded-2xl p-7">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <div className="font-['Syne'] text-[22px] font-bold leading-tight">{storeName}</div>
                  </div>
                  <div>
                    <div className="text-[11px] text-gray-400 mb-1">사업자번호</div>
                    <div className="text-[13px] font-mono">{ntsResult.b_no}</div>
                  </div>
                </div>
              </div>
